...
(custom-set-variables
 ...
 '(package-selected-packages
   '(grey-paper-theme gruvbox-theme company company-c-headers company-ctags helm-lsp lsp-haskell lsp-ivy lsp-ui lsp-mode lsp-treemacs white-theme dap-mode which-key f dash s org-xournalpp smex quelpa-use-package evil)))
(custom-set-faces
